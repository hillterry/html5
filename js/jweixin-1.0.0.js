!function (a, b) {
    ...
    function c(b, c, d) {
        //alert("a.WeixinJSBridge"+a.WeixinJSBridge)
        //alert(a.err_msg);
    ...
    function i(a, b, c) {
        ...
        c._complete && (c._complete(b),
            delete c._complete),
            d = b.errMsg || "",
        B.debug && !c.isInnerInvoke && alert(JSON.stringify(b)),
            e = d.indexOf(":"),
            f = d.substring(e + 1))
        {
            case"ok":
    ...
    if (!a.jWeixin)return q = {
        ...
        onMenuShareWeibo: function (a) {
            ...
            c("scanQRCode", {desc: a.desc, needResult: a.needResult || 0}, a)
