...
define(function (require, exports, module) {
    ...
    exports.init = function(cb){
        if(gVar.luncherShowType==100){//擦除
            showType100(cb);
        }else if(gVar.luncherShowType==101){//开门
            showType101(cb);
        }else if(gVar.luncherShowType==102){//唇印
            showType102(cb);
        }
    };
    ...
    function showType101(cb){
        ...
        container.on(Modernizr.touch?'touchstart':'mousedown',function(event){
