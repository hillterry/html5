define(function (require, exports, module) {
    ...
    function initCustomEvent(animcursor) {
        ...
        body.on(Modernizr.touch?'touchstart':'mousedown',function (e) {
            currentPage = $pages.filter('.p-current').get(0);
        ...
        }).on(Modernizr.touch?'touchmove':'mousemove',function (e) {
            if (e.type == 'touchmove') {
                moveDistanceX = e.touches[0].pageX - startX;
                moveDistanceY = e.touches[0].pageY - startY;
            } else {
        ...
        }).on(Modernizr.touch?'touchend':'mouseup', function (e) {
    ...
    exports.init = function () {
        ...
        if (gVar.isSwithPage === 1) {
            if (gVar.appPageSwitchIndex == 100 || gVar.appPageSwitchIndex == 0) {
                initDefaultEvent();
            } else {
                var indexMap = {
                    101: 1,
                ...
                initCustomEvent(indexMap[gVar.appPageSwitchIndex]);
            }
        }
    ...
    function turnPage(animation, lap) {
        ...
        var $nextPage = $pages.eq(current).addClass('p-active'),
